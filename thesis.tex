...
\draw[dotted,very thick] (0.75,0.05) .. controls (0.75,1.05) and (-0.65,1.05) .. (-0.65,2.05);
\draw (0.7,0) .. controls (0.7,1) and (-0.7,1) .. (-0.7,2);

\fill[white] (0.025,0.975) circle (0.125cm);

\draw[dotted,very thick] (-0.65,-0.05) .. controls (-0.65,0.95) and (0.75,0.95) .. (0.75,1.95);
\draw (-0.7,0) .. controls (-0.7,1) and (0.7,1) .. (0.7,2);
\end{tikzpicture}
$\quad \quad$
\begin{tikzpicture}
