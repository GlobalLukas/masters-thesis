...
\begin{proof}
It is clear that $(\Gamma_1' \otimes \Gamma_2') \circ (\Gamma_1 \otimes \Gamma_2) = (\Gamma_1' \circ \Gamma_1) \otimes (\Gamma_2' \circ \Gamma_2)$. The interchange law then comes from the commutative diagram
\begin{center}
\begin{tikzcd}[column sep=2cm]
\underline{\dot H}_{(\Gamma_1' \otimes \Gamma_2') \circ (\Gamma_1 \otimes \Gamma_2)} \arrow{r}{\alpha_{\Gamma_1 \otimes \Gamma_2,\Gamma_1' \otimes \Gamma_2'}} \arrow[equals]{d} &
\underline{\dot H}_{\Gamma_1 \otimes \Gamma_2} \otimes \underline{\dot H}_{\Gamma_1' \otimes \Gamma_2'} \arrow[equals]{r}{\sim} &
\underline{\dot H}_{\Gamma_1} \otimes \underline{\dot H}_{\Gamma_2} \otimes \underline{\dot H}_{\Gamma_1'} \otimes \underline{\dot H}_{\Gamma_2'} \arrow[equals]{d}{\wr} \\
\underline{\dot H}_{(\Gamma_1' \circ \Gamma_1) \otimes (\Gamma_2' \circ \Gamma_2)} \arrow[equals]{r}{\sim} &
\underline{\dot H}_{(\Gamma_1' \circ \Gamma_1)} \otimes \underline{\dot H}_{(\Gamma_2' \circ \Gamma_2)} \arrow{r}{\alpha_{\Gamma_1,\Gamma_1'} \otimes \alpha_{\Gamma_2,\Gamma_2'}} &
\underline{\dot H}_{\Gamma_1} \otimes \underline{\dot H}_{\Gamma_1'} \otimes \underline{\dot H}_{\Gamma_2} \otimes \underline{\dot H}_{\Gamma_2'}
\end{tikzcd}
\end{center}
\end{proof}
