...
\end{tikzcd}
\end{center}
The twist operators are mapped as...

The gluing of curves becomes tensoring over $Y(\mathfrak{gl}_\ell)$. What is $\int^y (L(\ydiagram{1})_y^t)^\vee \otimes_{Y(\mathfrak{gl}_\ell)} L(\ydiagram{1})_y^t$? The coadjoint $\mathfrak{gl}_\ell^*$?
